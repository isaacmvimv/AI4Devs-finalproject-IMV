...
- [ ] C.4 `git push -u origin feature/T-11-01-dominio-repositorio-recompensas`
- [ ] C.5 Merge a `develop`
- [ ] C.6 `mv` change → `openspec/changes/archive/YYYY-MM-DD-t-11-01-dominio-repositorio-recompensas/`
- [ ] C.7 `npm run openspec:mark-ticket -- --change t-11-01-dominio-repositorio-recompensas`
